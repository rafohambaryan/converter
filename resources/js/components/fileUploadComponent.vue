...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async metodPut() {
                //api/file/{id} PUT save kene es kspanem  { file:{} ,  format: xml } tescin
                // console.log(this.g);
